...
void hybrid(int pc_ct,int prog_ctr_gshare,int gbh_bits,int prog_ctr_bimodal,string trace_file){
  ...
  double rate =(double)mispred/(double)predict*100;
	cout<<"COMMAND"<<"\n";
	cout<<"./sim hybrid"<<"\t"<<pc_ct<<"\t"<<prog_ctr_gshare<<"\t"<<gbh_bits<<"\t"<<prog_ctr_bimodal<<"\t"<<trace_file<<"\n";
	cout<<"OUTPUT"<<"\n";
  cout<<"number of predictions:\t\t"<<predict<<"\n";
  cout<<"number of mispredictions:\t"<<mispred<<"\n";
  cout<<"misprediction rate:     "<<fixed<<setprecision(2)<<rate<<"%\n";
//double(ceil(rate/10)/100)
...
//function call removed
  ...
  double rate = (double)mispred/(double)predict*100;
	cout<<"COMMAND"<<"\n";
	cout<<"./sim gshare"<<"\t"<<"\t"<<pc<<"\t"<<gbh_bits<<"\t"<<trace_file<<"\n";
	cout<<"OUTPUT"<<"\n";
  cout<<"number of predictions:\t\t"<<predict<<"\n";
  cout<<"number of mispredictions:\t"<<mispred<<"\n";
  cout<<"misprediction rate:     "<<fixed<<setprecision(2)<<rate<<"%\n";
...
void bimodal(int pc, string trace_file){
  ...
  double rate = (double)mispred/(double)predict*100;
	cout<<"COMMAND"<<"\n";
	cout<<"./sim bimodal"<<"\t"<<"\t"<<pc<<trace_file<<"\n";
	cout<<"OUTPUT"<<"\n";
  cout<<"number of predictions:\t\t"<<predict<<"\n";
  cout<<"number of mispredictions:\t"<<mispred<<"\n";
  cout<<"misprediction rate:     "<<fixed<<setprecision(2)<<rate<<"%\n";
